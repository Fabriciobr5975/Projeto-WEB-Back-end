...
DELIMITER $$
CREATE TRIGGER trigger_atualizar_estoque_apos_insercao_carrinho
...
DELIMITER $$
CREATE TRIGGER trigger_atualizar_estoque_apos_alteracao_carrinho
...
DELIMITER $$
CREATE TRIGGER trigger_atualizar_estoque_apos_remocao_carrinho
...
/* Trigger para a atualização do estoque após a inserção do item do carrinho */
DELIMITER $$
CREATE TRIGGER trigger_atualizar_estoque_apos_insercao_pedido
...
/* Trigger para a atualização do estoque após a alteração do item do carrinho */
DELIMITER $$
CREATE TRIGGER trigger_atualizar_estoque_apos_alteracao_pedido
...
/* Trigger para a atualização do estoque após a remoção do item do carrinho */
DELIMITER $$
CREATE TRIGGER trigger_atualizar_estoque_apos_remocao_pedido
