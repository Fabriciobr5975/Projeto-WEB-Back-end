import { buscarItemPedidoPorId } from '../../repository/pedido/itensPedidoRepository.js'
import { validarEntradaParaBuscaPorItensPedido, validarBuscaItensPedido } from '../../validation/pedido/itemPedidoValidation.js'

export default async function buscarItensPedidoPorIdService(idItensPedido) {
    validarEntradaParaBuscaPorItensPedido(idItensPedido);

    const registro = await buscarItemPedidoPorId(idItensPedido);
